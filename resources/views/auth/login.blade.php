...
<div class="row justify-content-center">
    <div class="col-md-5">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <p class="text-muted small">Utilize as credenciais de administrador para gerenciar os contatos.</p>
            ...
            <div class="card-footer text-center">
                <a href="{{ route('contacts.index') }}" class="text-decoration-none small text-secondary">Voltar</a>
            </div>
        </div>
    </div>
</div>
